...
public class IndexController extends FreemarkerController
{
    ...
    public String index(HttpServletRequest request, ModelMap map)
    {
        ...
        request.getSession().setAttribute("menus", infos);
        /*map.put("menus", infos);*/
    ...
    public String upload(String uploadPath, String suffixs, String template, String title, ModelMap map)
    {
        map.put("uploadPath", uploadPath);
        map.put("suffixs", suffixs);
        map.put("title", title);
        map.put("template", template);
        return getViewName("plupload");
    }
