	...
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.applyUrl + '/form/input'+'/text',
				name:thePlugins,
				editor:this,
				title: '文本框',
...
UE.plugins['macros'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/macros.html',
                name:thePlugins,
                editor:this,
                title: '宏控件',
...
UE.plugins['radio'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/radio.html',
                name:thePlugins,
                editor:this,
                title: '单选框',
...
UE.plugins['checkbox'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/checkbox.html',
                name:thePlugins,
                editor:this,
                title: '复选框',
...
UE.plugins['radios'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/radios.html',
                name:thePlugins,
                editor:this,
                title: '单选框组',
                cssRules:"width:590px;height:370px;",
...
UE.plugins['checkboxs'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/checkboxs.html',
                name:thePlugins,
                editor:this,
                title: '复选框组',
...
UE.plugins['select'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/select.html',
                name:thePlugins,
                editor:this,
                title: '下拉菜单',
                cssRules:"width:590px;height:370px;",
...
UE.plugins['progressbar'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/progressbar.html',
                name:thePlugins,
                editor:this,
                title: '进度条',
...
UE.plugins['qrcode'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/qrcode.html',
                name:thePlugins,
                editor:this,
                title: '二维码',
...
UE.plugins['listctrl'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/listctrl.html',
                name:thePlugins,
                editor:this,
                title: '列表控件',
...
UE.plugins['more'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/more.html',
                name:thePlugins,
                editor:this,
...
UE.plugins['error'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/error.html',
                name:thePlugins,
                editor:this,
                title: '异常提示',
...
UE.plugins['leipi'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/leipi.html',
                name:thePlugins,
                editor:this,
                title: '表单设计器 - 清单',
...
UE.plugins['leipi_template'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.applyUrl + '/form/input'+'/template.html',
                name:thePlugins,
                editor:this,
                title: '表单模板',
