...
function(n) {
    var t = function(t, i) {
        ...
        n.fn.tree.defaults, i);
        this.$element.on("click", ".tree-item", n.proxy(function(n) {
        	var tt = $(n.currentTarget).data();
        	if (tt.click != undefined) tt.click(tt.uuid, tt.key);
        ...
        this.$element.on("click", ".tree-folder-header", n.proxy(function(n) {
        	var tt = $(n.currentTarget).data();
        	if (tt.click != undefined) tt.click(tt.uuid, tt.key);
        	//if (tt.click != undefined && $(n.currentTarget).find('.fa-folder-open').length == 0) tt.click(tt.uuid, tt.key);
    ...
    t.prototype = {
        ...
        populate: function(t) {
            ...
            u.show();
            this.options.dataSource.data(t.data(),
            function(f) {
                u.hide();
                n.each(f.data,
                function(u, f) {
