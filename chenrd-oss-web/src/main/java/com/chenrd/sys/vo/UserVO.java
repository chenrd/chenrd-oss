...
public class UserVO extends VO implements QueryInfo {
	...
	public static final UserVO USABLE_USER = new UserVO(Status.ON); //可用的用户 status = 1
	...
	public UserVO(String id, String username, String phone, String name, int sex, int status, Date createDate) {
		super();
		this.id = id;
