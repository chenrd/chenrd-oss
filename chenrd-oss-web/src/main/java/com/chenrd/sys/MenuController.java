...
@RequestMapping("menu")
@Controller
public class MenuController extends FreemarkerController {
	...
	public String edit(@PathVariable Long id, Long applyId, String parentKey, ModelMap map) {
		if (id != null) {
			...
			map.put("bean", bean);
			map.put("childs", funcManager.find("find", FuncVO.class, new PowerCommonQueryInfo(parentKey, Status.ON, PowerType.FUNC_POWER)));
		}
